...
Service.create([
  ...
  {ordinal: 0, name: "Component Sales, Exchange and Loan", description: "ASC hold an extensive inventory of rotable components at our main base at London Gatwick Airport. Although incorporating other aircraft types, our main focus are the Boeing and Airbus narrowbody aircraft. Our inventory includes multiple ship-sets of Wheels and Brakes equipment across OEMs including Messier-Bugatti-Dowty, Goodrich, Honeywell, and Meggitt.\n\nOur inventory comes fully certified to EASA/FAA standards, with the latest modifications and ADs incorporated. ASC pride ourselves on our speed, flexibility, and reliability, and as such all our exchange cores come with guaranteed warranties.", slider_description: "ASC hold an extensive inventory of rotable components at our main base at London Gatwick Airport", contact_details: "For an instant quote please call us on +44 (0)1293583224 or email enquiries@ascltd.com\n\nOtherwise contact our AOG Team on +44(0)1293 583222 or aog@ascltd.com"},
  ...
  {ordinal: 30, name: "Initial Provisioning / Sourcing Solutions", description: "With a wealth of management experience within top airlines and stockists, ASC are ideally placed within the industry to provide initial provisioning and sourcing support. With an extensive inventory holding at London Gatwick and other locations, and good relationships with many major OEMs, ASC can take the hassle out our your I.P. operations and deliver a reliable service tailored to your specific individual needs.", slider_description: "ASC are ideally placed within the industry, with a wealth of management experience within top airlines and stockists", contact_details: "To discuss ASC’s sourcing solutions please call +44 (0)1293 583200\n\nOr email enquiries@ascltd.com"},
  {ordinal: 55, name: "Interiors, IFE & Ramp Services", description: "Please visit http://airline-services.com", slider_description: ""},
